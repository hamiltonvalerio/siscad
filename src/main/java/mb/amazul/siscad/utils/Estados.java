...
public enum Estados {
	...
	private static Map<Integer, Estados> valueToTextMapping;
	
	 public static Estados getStatus(Integer i){
	 ...
	 private static void initMapping(){
	        ...
	        for(Estados s : values()){
	            valueToTextMapping.put(s.codigoIbge, s);
	        }
	    }
